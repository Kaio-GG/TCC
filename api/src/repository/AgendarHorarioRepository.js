...
export default async function AgendarHorario (info){
    ...
    `
    const [linhas] = await con.query (comando, [info.id_agendamento , info.id_cliente , info.nome , info.email ,  info.cpf  ,  info.telefone , info.sexo , info.nascimento , info.situacao , info.descricao]);
